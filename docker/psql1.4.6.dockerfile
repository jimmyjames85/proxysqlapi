...
RUN wget -O /tmp/proxysql-1.4.6-1-centos7.x86_64.rpm https://github.com/sysown/proxysql/releases/download/v1.4.6/proxysql-1.4.6-1-centos7.x86_64.rpm
RUN yum install -y  /tmp/proxysql-1.4.6-1-centos7.x86_64.rpm
